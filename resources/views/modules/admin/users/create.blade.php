...
@section('content')
    <x-breadcrumb>
        ...
        <x-breadcrumb.item href="{{ route('admin.users') }}">Users</x-breadcrumb.item>
        <x-breadcrumb.item href="#">Create User</x-breadcrumb.item>
    </x-breadcrumb>
    <x-module x-data="adminUsers()">
        <x-module.header>
            <x-module.title>Create User</x-module.title>
        </x-module.header>
        <x-card>
            <x-card.content>
